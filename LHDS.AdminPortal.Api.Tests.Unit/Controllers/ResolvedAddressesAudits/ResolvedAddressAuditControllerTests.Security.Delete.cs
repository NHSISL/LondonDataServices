...
namespace LHDS.AdminPortal.Api.Tests.Unit.Controllers.ResolvedAddressAudits
{
    public partial class ResolvedAddressAuditControllerTests
    {
        ...
        {
            // given
            var controllerType = typeof(ResolvedAddressesAuditController);
            var methodInfo = controllerType.GetMethod("DeleteResolvedAddressAuditByIdAsync");
            ...
            List<string> expectedAttributeValues = new List<string>
            {
                ...
                "ISL.LDS.AdminApi.ResolvedAddress"
            };
