...
namespace LHDS.AdminPortal.Api.Controllers
{
    ...
    public class TerminologyArtifactController : RESTFulController
    {
        private readonly ITerminologyArtifactService terminologyArtifactService;

        public TerminologyArtifactController(ITerminologyArtifactService terminologyArtifactService) =>
...
#endif
        public async ValueTask<ActionResult<TerminologyArtifact>> PostSupplierAsync(TerminologyArtifact terminologyArtifact)
        {
            try
            {
            ...
            catch (TerminologyArtifactValidationException terminologyArtifactException)
            {
                return BadRequest(terminologyArtifactException.InnerException);
            }
            catch (TerminologyArtifactDependencyValidationException supplierValidationException)
