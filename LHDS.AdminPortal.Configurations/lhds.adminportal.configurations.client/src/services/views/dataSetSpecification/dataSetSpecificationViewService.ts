...
type dataSetSpecificationViewServiceResponse = {
    ...
    pages: Array<{ data: DataSetSpecificationView[] }>;
    isLoading: boolean;
    fetchNextPage: () => void;
    isFetchingNextPage: boolean;
    hasNextPage: boolean;
    data: { pages: Array<{ data: DataSetSpecificationView[] }> } | undefined;
    refetch: () => void
}
...
export const dataSetSpecificationViewService = {
    ...
    useGetAllDataSetSpecifications: (dataSetId: string, searchTerm?: string,): dataSetSpecificationViewServiceResponse => {
        ...
        const [pages, setPages] = useState<Array<{ data: DataSetSpecificationView[] }>>([]);
    ...
    useGetDataSetSpecificationById: (id: string) => {
