...
export const resolvedAddressViewService = {
    ...
    useGetAllResolvedAddresses: (searchTerm?: string) => {
        try {
            ...
            useEffect(() => {
                if (response.data) {
                    const resolvedAddresses = response.data.map((resolvedAddress: ResolvedAddress) =>
                        new ResolvedAddressView(
                            ...
                            resolvedAddresses.buildingName,
                            resolvedAddresses.buildingNumber,
                            resolvedAddresses.dependentThoroughfare,
                            resolvedAddresses.thoroughfare,
                            resolvedAddresses.doubleDependentLocality,
                            resolvedAddresses.dependentLocality,
                            resolvedAddresses.postTown,
                            resolvedAddresses.postCode,
                            resolvedAddresses.createdBy,
                            resolvedAddresses.createdDate,
                            resolvedAddresses.updatedBy,
                            resolvedAddresses.updatedDate,
                        ));
