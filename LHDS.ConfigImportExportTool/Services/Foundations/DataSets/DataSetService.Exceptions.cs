...
namespace LHDS.Core.Services.Foundations.DataSets
{
    internal partial class DataSetService
    {
        ...
        private DataSetValidationException CreateAndLogValidationException(Xeption exception)
        {
            ...
            this.loggingBroker.LogErrorAsync(dataSetValidationException);
        ...
        private DataSetDependencyValidationException CreateAndLogDependencyValidationException(Xeption exception)
        {
            ...
            this.loggingBroker.LogErrorAsync(dataSetDependencyValidationException);
            ...
            Xeption exception)
        {
            ...
            this.loggingBroker.LogErrorAsync(dataSetDependencyException);
