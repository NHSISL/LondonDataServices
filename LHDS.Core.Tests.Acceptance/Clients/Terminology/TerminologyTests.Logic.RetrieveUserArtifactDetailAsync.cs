...
namespace LHDS.Core.Tests.Acceptance.Clients.Terminology
{
    public partial class TerminologyTests
    {
        ...
        public async Task ShouldRetrieveUserArtifactDetailsAsync()
        {
            ...
            //When
            await this.terminologyClient.RetrieveUserArtifactDetailsAsync();
            ...
            retrievedTerminologyArtifact.IsDownloadedForUser.Should().BeTrue();
            string fileName = $"Subscribers/{retrievedTerminologyArtifact.ResourceType}/{retrievedTerminologyArtifact.Name}.json";
