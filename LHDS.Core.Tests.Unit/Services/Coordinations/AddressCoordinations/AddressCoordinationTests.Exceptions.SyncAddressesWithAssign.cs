...
namespace LHDS.Core.Tests.Unit.Services.Coordinations.AddressCoordinations
{
    public partial class AddressCoordinationServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationOnSyncAddressesWithAssignIfErrorOccursAndLogItAsync(
            Xeption dependancyValidationException)
        {
            ...
            // when
            ValueTask syncAddressesTask =
                this.addressCoordinationService.SyncAddressesWithAssignAsync();

            AddressCoordinationDependencyValidationException actualException =
                await Assert.ThrowsAsync<AddressCoordinationDependencyValidationException>(syncAddressesTask.AsTask);
        ...
        public async Task ShouldThrowDependencyExceptionOnSyncAddressesWithAssignIfDependencyErrorOccursAndLogItAsync(
            Xeption dependencyException)
        {
            ...
            AddressCoordinationDependencyException actualException =
                await Assert.ThrowsAsync<AddressCoordinationDependencyException>(syncAddressesTask.AsTask);
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnSyncAddressesWithAssignIfServiceErrorOccursAndLogItAsync()
        {
            // given
            ...
            AddressCoordinationServiceException actualException =
                await Assert.ThrowsAsync<AddressCoordinationServiceException>(syncAddressesTask.AsTask);
