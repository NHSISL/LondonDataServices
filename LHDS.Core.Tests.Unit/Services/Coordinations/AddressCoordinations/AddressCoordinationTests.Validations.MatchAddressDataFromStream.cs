...
namespace LHDS.Core.Tests.Unit.Services.Coordinations.AddressCoordinations
{
    public partial class AddressCoordinationServiceTests
    {
        ...
        [InlineData("", "empty")]
        [InlineData(" ", "empty")]
        public async Task ShouldThrowValidationExceptionOnMatchAddressDataFromStreamIfDataIsNullAndLogItAsync(
            string invalidText, string invalidStreamType)
        {
            ...
            ValueTask matchAddressDataTask =
                this.addressCoordinationService.MatchAddressDataFromStreamAsync(invalidStream, invalidFilename);
