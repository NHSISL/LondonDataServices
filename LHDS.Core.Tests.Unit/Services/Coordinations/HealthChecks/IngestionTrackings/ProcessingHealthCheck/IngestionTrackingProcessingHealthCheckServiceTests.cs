...
namespace LHDS.Core.Tests.Unit.Services.Coordinations.HealthChecks.IngestionTrackings.ProcessingHealthCheck
{
    public partial class IngestionTrackingProcessingHealthCheckServiceTests
    {
        ...
        private readonly IngestionTrackingProcessingHealthCheckService
        ...
        public IngestionTrackingProcessingHealthCheckServiceTests()
        {
            ...
            this.ingestionTrackingProcessingHealthCheckService =
                new IngestionTrackingProcessingHealthCheckService(
            ...
            DateTimeOffset updatedDate)
        {
            ...
            filler.Setup()
                ...
                .OnProperty(ingestionTracking => ingestionTracking.IsProcessing).Use(true)
            ...
            int unhealthyItemsCount = 0)
        {
            ...
            {
                message = $"{nonHealthyItemsCount} files have not been processed. Please check logs and function status.";
            }

            return new Dictionary<string, object>
            {
                { "description", "Processing Queue" },
                { "stuckInProcessing", nonHealthyItemsCount},
