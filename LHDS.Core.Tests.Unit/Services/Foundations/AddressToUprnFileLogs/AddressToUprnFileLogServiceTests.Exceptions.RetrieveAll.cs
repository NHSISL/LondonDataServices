...
namespace LHDS.Core.Tests.Unit.Services.Foundations.AddressToUprnFileLogs
{
    public partial class AddressToUprnFileLogServiceTests
    {
        ...
        public async Task ShouldThrowCriticalDependencyExceptionOnRetrieveAllWhenSqlExceptionOccursAndLogItAsync()
        {
            ...
            // when
            ValueTask<IQueryable<AddressToUprnFileLog>> retrieveAllTask =
                this.addressToUprnFileLogService.RetrieveAllAddressToUprnFileLogsAsync();

            AddressToUprnFileLogDependencyException actualException =
                await Assert.ThrowsAsync<AddressToUprnFileLogDependencyException>(retrieveAllTask.AsTask);
        ...
        public async Task ShouldThrowServiceExceptionOnRetrieveAllIfServiceErrorOccursAndLogItAsync()
        {
            ...
            AddressToUprnFileLogServiceException actualException =
                await Assert.ThrowsAsync<AddressToUprnFileLogServiceException>(retrieveAllTask.AsTask);
