...
namespace LHDS.Core.Tests.Unit.Services.Foundations.Addresses
{
    public partial class AddressServiceTests
    {
        ...
        [InlineData("")]
        [InlineData(" ")]
        public async Task ShouldThrowValidationExceptionOnBulkAddIfAddressIsInvalidAndLogItAsync(string invalidText)
        {
            // given
            ...
            // when
            ValueTask bulkAddAddressTask =
                this.addressService.BulkAddAddressesAsync(addresses: invalidAddresses, fileName: invalidFileName);

            AddressValidationException actualAddressValidationException =
                await Assert.ThrowsAsync<AddressValidationException>(bulkAddAddressTask.AsTask);
