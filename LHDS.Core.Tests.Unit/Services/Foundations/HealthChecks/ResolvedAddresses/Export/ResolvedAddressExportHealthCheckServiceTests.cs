...
namespace LHDS.Core.Tests.Unit.Services.Foundations.HealthChecks.ResolvedAddresses.Export
{
    public partial class ResolvedAddressExportHealthCheckServiceTests
    {
        ...
        public ResolvedAddressExportHealthCheckServiceTests()
        {
            ...
            this.resolvedAddressHealthItemService = new ResolvedAddressExportHealthCheckService(
        ...
        private static List<ResolvedAddress> CreateRandomResolvedAddresses(
            ...
            int count)
        {
            return CreateResolvedAddressFiller(dateTimeOffset, isProcessed, isExported)
                .Create(count)
                    .ToList();
        }
