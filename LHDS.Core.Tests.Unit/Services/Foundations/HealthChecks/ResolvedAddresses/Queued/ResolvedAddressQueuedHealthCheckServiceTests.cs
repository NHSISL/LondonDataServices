...
namespace LHDS.Core.Tests.Unit.Services.Foundations.HealthChecks.ResolvedAddresses.Queued
{
    public partial class ResolvedAddressQueuedHealthCheckServiceTests
    {
        ...
        public ResolvedAddressQueuedHealthCheckServiceTests()
        {
            ...
            this.resolvedAddressHealthItemService = new ResolvedAddressQueuedHealthCheckService(
        ...
        private static List<ResolvedAddress> CreateRandomResolvedAddresses(
            ...
            int count)
        {
            return CreateResolvedAddressFiller(dateTimeOffset, isProcessing, isProcessed)
                .Create(count)
                    .ToList();
        }
