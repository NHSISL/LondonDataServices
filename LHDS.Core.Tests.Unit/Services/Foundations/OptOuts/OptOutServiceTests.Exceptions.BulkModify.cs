...
namespace LHDS.Core.Tests.Unit.Services.Foundations.OptOuts
{
    public partial class OptOutServiceTests
    {
        [Fact]
        public async Task
            ShouldThrowAggregateServiceExceptionOnBulkModifyIfErrorOccursAndLogItAsync()
        {
            // given
            ...
            // when
            ValueTask bulkModifyOptOutTask = optOutServiceMock.Object
                .BulkModifyOptOutsAsync(
                    optOuts: someOptOuts,
                    fileName: someFileName);

            OptOutServiceException actualOptOutServiceException =
                await Assert.ThrowsAsync<OptOutServiceException>(
                    bulkModifyOptOutTask.AsTask);
        ...
        [Fact]
        public async Task
            ShouldThrowServiceExceptionOnBulkModifyIfServiceErrorOccursAndLogItAsync()
        {
            // given
            ...
            // when
            ValueTask modifyOptOutTask = optOutServiceMock.Object
                .BulkModifyOptOutsAsync(
                    optOuts: someOptOuts,
                    fileName: someFileName);
