...
namespace LHDS.Core.Tests.Unit.Services.Foundations.SubscriberAgreements
{
    public partial class SubscriberAgreementServiceTests
    {
        [Fact]
        public async Task
            ShouldThrowCriticalDependencyExceptionOnRetrieveByRetrieveBySupplierSharingAgreementGuidIfSqlErrorOccursAndLogItAsync()
        {
            // given
            ...
            ValueTask<SubscriberAgreement> retrieveSubscriberAgreementByIdTask =
                this.subscriberAgreementService.RetrieveSubscriberAgreementBySupplierSharingAgreementGuidAsync(someId);
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveBySupplierSharingAgreementGuidIfServiceErrorOccursAndLogItAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
