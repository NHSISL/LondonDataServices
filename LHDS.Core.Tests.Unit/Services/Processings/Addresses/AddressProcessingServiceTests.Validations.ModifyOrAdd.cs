...
namespace LHDS.Core.Tests.Unit.Services.Processings.Addresses
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionsOnModifyOrAddIfAddressProcessingIsNullAndLogItAsync()
        {
            // given
            ...
            ValueTask<Address> AddAddressTask =
                this.addressProcessingService.ModifyOrAddAddressAsync(nullAddress);
        ...
        public async Task ShouldThrowValidationExceptionsOnModifyOrAddIfIdIsInvalidAndLogItAsync()
        {
            ...
            ValueTask<Address> RetrieveAddressTask =
                this.addressProcessingService.ModifyOrAddAddressAsync(invalidAddress);
