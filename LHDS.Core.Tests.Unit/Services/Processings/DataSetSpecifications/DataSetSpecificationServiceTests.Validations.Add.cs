...
namespace LHDS.Core.Tests.Unit.Services.Processings.DataSetSpecifications
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionsOnAddIfDataSetSpecificationProcessingIsNullAndLogItAsync()
        {
            // given
            ...
            ValueTask<DataSetSpecification> AddDataSetSpecificationTask =
                this.dataSetSpecificationProcessingService.AddDataSetSpecificationAsync(nullDataSetSpecification);
