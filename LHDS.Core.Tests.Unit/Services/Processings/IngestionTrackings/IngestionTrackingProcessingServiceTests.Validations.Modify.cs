...
namespace LHDS.Core.Tests.Unit.Services.Processings.IngestionTrackings
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionsOnModifyIfIngestionTrackingProcessingIsNullAndLogItAsync()
        {
            // given
            ...
            ValueTask<IngestionTracking> AddIngestionTrackingTask =
                this.ingestionTrackingProcessingService.ModifyIngestionTrackingAsync(nullIngestionTracking);
