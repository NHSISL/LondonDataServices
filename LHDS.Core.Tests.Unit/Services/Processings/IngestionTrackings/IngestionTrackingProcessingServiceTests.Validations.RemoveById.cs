...
namespace LHDS.Core.Tests.Unit.Services.Processings.IngestionTrackings
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionsOnRemoveByIdIfIdIsInvalidAndLogItAsync()
        {
            // given
            ...
            ValueTask<IngestionTracking> RetrieveIngestionTrackingTask =
                this.ingestionTrackingProcessingService.RemoveIngestionTrackingByIdAsync(invalidId);
