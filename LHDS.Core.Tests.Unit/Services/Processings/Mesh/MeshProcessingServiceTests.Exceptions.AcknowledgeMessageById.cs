...
namespace LHDS.Core.Tests.Unit.Services.Processings.Mesh
{
    public partial class MeshProcessingServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnAcknowledgeIfDependencyValidationErrorOccursAndLogItAsync(
            Xeption dependencyValidationException)
        {
            ...
            ValueTask<bool> acknowledgeTask =
                this.meshProcessingService.AcknowledgeMessageByIdAsync(
        ...
        public async Task ShouldThrowDependencyOnAcknowledgeIfDependencyErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnAcknowledgeIfServiceErrorOccursAsync()
        {
            // given
            MeshMessage randomMessage = CreateRandomMessage();
