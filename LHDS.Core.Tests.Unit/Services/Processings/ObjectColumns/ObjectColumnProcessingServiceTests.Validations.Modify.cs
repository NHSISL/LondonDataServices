...
namespace LHDS.Core.Tests.Unit.Services.Processings.ObjectColumns
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionsOnModifyIfObjectColumnProcessingIsNullAndLogItAsync()
        {
            // given
            ...
            ValueTask<ObjectColumn> AddObjectColumnTask =
                this.objectColumnProcessingService.ModifyObjectColumnAsync(nullObjectColumn);
