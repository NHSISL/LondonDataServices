...
namespace LHDS.Core.Tests.Unit.Services.Processings.Ontologies
{
    public partial class OntologyProcessingServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveAllConceptMapsIfErrorOccursAndLogItAsync(
            Xeption dependencyValidationException)
        {
            ...
            ValueTask<OntologyAssets> ontologyRetrieveCodingSystemsAction =
                this.ontologyProcessingService.RetrieveAllConceptMapsAsync(relativeUrl);
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveAllConceptMapsAsyncIfErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveAllConceptMapsIfServiceErrorOccursAsync()
        {
            // given
            string relativeUrl = GetRandomString();
