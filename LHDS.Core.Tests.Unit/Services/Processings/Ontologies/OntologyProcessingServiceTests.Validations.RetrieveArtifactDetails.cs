...
namespace LHDS.Core.Tests.Unit.Services.Processings.Ontologies
{
    public partial class OntologyProcessingServiceTests
    {
        ...
        [InlineData("")]
        [InlineData(" ")]
        public async Task ShouldThrowValidationExceptionOnRetrieveArtifactDetailssIfUrlIsInvalidAndLogItAsync(
            string invalidText)
        {
            ...
            // when
            ValueTask<string> retrieveOntologyByRelativeUrlTask =
                this.ontologyProcessingService.RetrieveArtifactDetailsAsync(invalidFileName);
