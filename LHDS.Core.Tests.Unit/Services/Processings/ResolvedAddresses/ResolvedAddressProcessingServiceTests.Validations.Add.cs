...
namespace LHDS.Core.Tests.Unit.Services.Processings.ResolvedAddresses
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionsOnAddIfResolvedAddressProcessingIsNullAndLogItAsync()
        {
            // given
            ...
            ValueTask<ResolvedAddress> AddResolvedAddressTask =
                this.resolvedAddressProcessingService.AddResolvedAddressAsync(nullResolvedAddress);
