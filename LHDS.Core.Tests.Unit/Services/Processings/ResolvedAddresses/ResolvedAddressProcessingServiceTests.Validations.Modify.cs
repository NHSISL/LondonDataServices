...
namespace LHDS.Core.Tests.Unit.Services.Processings.ResolvedAddresses
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionsOnModifyIfResolvedAddressProcessingIsNullAndLogItAsync()
        {
            // given
            ...
            ValueTask<ResolvedAddress> AddResolvedAddressTask =
                this.resolvedAddressProcessingService.ModifyResolvedAddressAsync(nullResolvedAddress);
