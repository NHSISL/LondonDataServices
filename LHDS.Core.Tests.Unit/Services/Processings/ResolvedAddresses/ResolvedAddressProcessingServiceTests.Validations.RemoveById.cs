...
namespace LHDS.Core.Tests.Unit.Services.Processings.ResolvedAddresses
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionsOnRemoveIfResolvedAddressProcessingIsNullAndLogItAsync()
        {
            // given
            ...
            ValueTask<ResolvedAddress> RetrieveResolvedAddressTask =
                this.resolvedAddressProcessingService.RemoveResolvedAddressByIdAsync(invalidId);
