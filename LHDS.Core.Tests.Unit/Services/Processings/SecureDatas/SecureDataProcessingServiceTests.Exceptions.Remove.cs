...
namespace LHDS.Core.Tests.Unit.Services.Processings.SecureDatas
{
    public partial class SecureDataProcessingServiceTests
    {
        ...
        public async Task ShouldThrowAggregateDependencyValidationExceptionOnRemoveIfErrorsInLoopAndLogItAsync(
            Xeption dependencyValidationException)
        {
            ...
            foreach (string keyType in keyTypes)
            {
                this.secureDataServiceMock.Setup(service =>
                    service.RemoveSecureDataAsync(It.IsAny<string>()))
        ...
        public async Task ShouldThrowAggregateDependencyExceptionOnRemoveIfErrorsInLoopAndLogItAsync(
