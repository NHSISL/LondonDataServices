...
namespace LHDS.Core.Tests.Unit.Services.Processings.SubscriberAgreements
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionsOnModifyIfSubscriberAgreementProcessingIsNullAndLogItAsync()
        {
            // given
            ...
            ValueTask<SubscriberAgreement> subscriberAgreementModifyTask =
                this.subscriberAgreementProcessingService.ModifySubscriberAgreementAsync(nullSubscriberAgreement);
