...
namespace LHDS.Core.Migrations
{
    ...
    [Migration("20231003123508_UpdateDataSetSupplier")]
            ...
            modelBuilder.Entity("LHDS.Core.Models.Foundations.Suppliers.Supplier", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 10, 3, 12, 35, 8, 532, DateTimeKind.Unspecified).AddTicks(6129), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Emis Supplier",
                            FriendlyName = "EMIS",
                            Name = "EMIS",
                            UpdatedBy = "System",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 10, 3, 12, 35, 8, 532, DateTimeKind.Unspecified).AddTicks(6136), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
