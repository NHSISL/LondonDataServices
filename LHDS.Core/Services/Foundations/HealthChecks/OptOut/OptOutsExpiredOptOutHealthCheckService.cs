...
{
    public class OptOutsExpiredOptOutHealthCheckService : IOptOutHealthItemService
    {
        ...
        public async ValueTask<HealthCheckResult> GetHealthStatusAsync()
        {
            ...
            int lastSentExpiredAfterDays = configuration.GetValue($"{ConfigSectionName}:LastSentExpiredAfterDays", 2);
