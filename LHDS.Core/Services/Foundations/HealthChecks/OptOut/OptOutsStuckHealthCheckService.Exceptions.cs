            ...
            ReturningHealthCheckResultFunction returningHealthCheckResultFunction)
        {
            ...
            catch (Exception exception)
            {
                ...
                throw await CreateAndLogServiceExceptionAsync(
                    failedOptOutsStuckHealthCheckServiceException);
            }
        }

        private async ValueTask<OptOutsStuckHealthCheckServiceException> CreateAndLogServiceExceptionAsync(
            Xeption exception)
        {
            var optOutsStuckHealthCheckServiceException =
            ...
            await this.loggingBroker.LogCriticalAsync(optOutsStuckHealthCheckServiceException);

            return optOutsStuckHealthCheckServiceException;
        }
    }
}
