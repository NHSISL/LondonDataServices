        ...
        public ValueTask<OntologyCodeSystem> ModifyOntologyCodeSystemAsync(OntologyCodeSystem ontologyCodeSystem) =>
            TryCatch(async () =>
            {
                ...
                OntologyCodeSystem maybeOntologyCodeSystem =
                    await this.storageBroker.SelectOntologyCodeSystemByIdAsync(ontologyCodeSystem.Id);

                ValidateStorageOntologyCodeSystem(maybeOntologyCodeSystem, ontologyCodeSystem.Id);
                ValidateAgainstStorageOntologyCodeSystemOnModify(inputOntologyCodeSystem: ontologyCodeSystem, storageOntologyCodeSystem: maybeOntologyCodeSystem);
