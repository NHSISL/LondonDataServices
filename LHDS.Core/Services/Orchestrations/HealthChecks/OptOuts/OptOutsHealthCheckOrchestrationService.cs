...
namespace LHDS.Core.Services.Orchestrations.HealthChecks.OptOuts
{
    public class OptOutsHealthCheckOrchestrationService : IHealthCheck
    {
        private readonly IEnumerable<IOptOutHealthItemService> healthItems;
        private readonly IDateTimeBroker dateTimeBroker;
        private const string healthCheckName = "Opt Outs Health Checks";

        public OptOutsHealthCheckOrchestrationService(
            IEnumerable<IOptOutHealthItemService> healthItems,
