...
namespace LHDS.Core.Services.Orchestrations.HealthChecks.TerminologyArtifacts
{
    public class TerminologyArtifactsHealthCheckCoordinationService : IHealthCheck
    {
        private readonly IEnumerable<ITerminologyArtifactsHealthItemService> healthItems;
        private readonly IDateTimeBroker dateTimeBroker;
        private const string healthCheckName = "Terminology Artifacts Health Checks";

        public TerminologyArtifactsHealthCheckCoordinationService(
            IEnumerable<ITerminologyArtifactsHealthItemService> healthItems,
