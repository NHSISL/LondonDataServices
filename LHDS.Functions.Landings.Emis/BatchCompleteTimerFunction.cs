...
{
    public class BatchCompleteTimerFunction
    {
        ...
        public BatchCompleteTimerFunction(
            ...
            LandingConfiguration landingConfiguration)
        {
            ...
            this.logger = loggerFactory.CreateLogger<BatchCompleteTimerFunction>();
            this.landingConfiguration = landingConfiguration;
        }

        [Function("BatchCompleteTimerFunction")]
        public async Task Run([TimerTrigger("%batchCompleteTimerFunction%")] MyInfo myTimer)
        {
